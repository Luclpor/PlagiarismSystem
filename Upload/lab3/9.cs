...
namespace Lab.Projection
{
     ...
     * М8О-307Б-20
     * Вариант-3
     * Реализовать простую модель закраски для случая одного источника света. Параметры освещения и отражающие свойства материала задаются пользователем в диалоговом режиме.
     * Шар
     */
    public class Scene
    {
        ...
        public Bitmap SceneBmp { get; private set; }
        ...
        public Scene(int w, int h)
        {
            ...
            _graphics = Graphics.FromImage(SceneBmp);
        }

        public void Clear(System.Drawing.Brush background)
        {
            _graphics.FillRectangle(background, new Rectangle(0, 0, Width, Height));
            Image newImage = Image.FromFile("C:\\Users\\assas\\OneDrive\\Рабочий стол\\Камень.jpg");
            ...
            RectangleF srcRect = new RectangleF(0, 0, 1500, 1500);
            GraphicsUnit units = GraphicsUnit.Pixel;

            // Draw image to screen.
            _graphics.DrawImage(newImage, x, y, srcRect, units);
        }
